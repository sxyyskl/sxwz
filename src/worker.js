const defaultUrl = `https://raw.githubusercontent.com/${atob('Rm9vbFZQTi1JRC9OYXV0aWNh')}/refs/heads/main/${atob('cHJveHlMaXN0LnR4dA')}`;
	...
	const tableRows = rows.length
        ...
        <tr>
          ...
          <td>${escapeHTML(org)}</td>
				...
				.join('')
		: `<tr><td colspan="4" style="text-align: center; font-style: italic; color: #666;">No data available</td></tr>`;
